...
def get_release_config(config):
    ...
    # no partner config unless we've explicitly enabled the repacks
    if config.params['release_enable_partners']:
        # don't leak partner config in non-partner jobs
    ...
    # TODO duplicate with release_enable_eme-free ??
    # TODO what controls the parameters ?

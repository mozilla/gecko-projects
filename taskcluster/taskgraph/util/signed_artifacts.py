...
def generate_specifications_of_artifacts_to_sign(
    ...
    # signed at after this stage of the release
        ...
        if 'win32' in build_platform and is_nightly:
            artifacts_specificications[0]['artifacts'] += ['public/build/{locale}/setup-stub.exe']
    ...
    if not keep_locale_template:
        artifacts_specificications = _strip_locale_template(artifacts_specificications)

    return artifacts_specificications

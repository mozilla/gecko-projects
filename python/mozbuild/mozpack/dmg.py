...
def repackage_dmg(source_directory, output_dmg):
    ...
    # The extra_files argument is empty [] because they are already a part of
    # the original dmg produced by the build, and they remain in the tarball
    # generated by the signing task.
    create_dmg(source_directory, output_dmg, volume_name, [])

...
#ifndef mozilla_toolkit_recordreplay_InfallibleVector_h
#define mozilla_toolkit_recordreplay_InfallibleVector_h
...
#endif // mozilla_toolkit_recordreplay_InfallibleVector_h

...
#ifndef mozilla_toolkit_recordreplay_ChunkAllocator_h
#define mozilla_toolkit_recordreplay_ChunkAllocator_h
...
#endif // mozilla_toolkit_recordreplay_ChunkAllocator_h

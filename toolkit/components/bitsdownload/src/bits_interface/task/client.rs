...
use super::{
    action::Action,
    error::{BitsTaskError, ErrorType::MissingBitsClient, ErrorStage::{CommandThread}},
...
/**
 * This structure holds the data needed to initialize BitsClient and BitsMonitorClient
 */
#[derive(Debug, Clone)]

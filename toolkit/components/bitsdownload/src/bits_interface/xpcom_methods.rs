...
///
/// It allows parameters to be specified as [optional], which allows them to be
/// null. It will pass these parameters as an Options, with null pointers being
/// converted to None.
///
/// It returns errors via the callback rather than via the return value.
///

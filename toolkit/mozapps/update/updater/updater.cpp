 ...
 *
 * @param  outBuf
 *         A buffer of size 37 to store the result. The uuid is 32 characters
 *         in length and 1 more for null termination.

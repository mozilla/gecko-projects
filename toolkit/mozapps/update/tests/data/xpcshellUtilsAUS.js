...
/**
 * Helper function to set incorrect permissions on a file.
 * This function should only be called on Windows platforms.
 *
 * @param    aPath
 *           The path to the file to change permissions on.
 * @return   true if the permissions were set, false on failure.
 */
...
/**
 * Helper function to create a directory junction.
 * This function should only be called on Windows platforms.
 *
 * @param    aLinkPath
...
/**
 * Helper function to create a hard link.
 * This function should only be called on Windows platforms.
 *
 * @param    aLinkPath
 ...
 * This function should only be called on Windows platforms.
 *
 * @param    aShouldUseService
 *           If false, this process will attempt to set the permissions itself.
 *           If true and this process fails to set permissions itself, the
 *           maintenance service will be used to set the permissions.
 * @return   true on success, false on failure
 */
async function fixUpdateDirectoryPerms(aShouldUseService = false) {
  ...
  logTestInfo(
    "Attempting to fix permissions. aShouldUseService = " + aShouldUseService
  );
  Cc["@mozilla.org/updates/update-processor;1"]
    .createInstance(Ci.nsIUpdateProcessor)
    .fixUpdateDirectoryPerms(aShouldUseService);
